...
export const sessionResponseSchema = z.object({
    ...
    availableTenants: z.array(z.object({
        id: z.uuid(),
        name: z.string(),
        slug: z.string(),
        demo: z.boolean(),
...
const optionalQueryText = (max) => z.preprocess((value) => (value === "" || value === undefined ? undefined : value), z.string().trim().max(max).optional());
export const nfeListQuerySchema = z
    .object({
    page: z.coerce.number().int().min(1).default(1),
    pageSize: z.coerce.number().int().min(1).max(100).default(50),
    numero: optionalQueryText(50),
    serie: z.preprocess((value) => (value === "" || value === undefined ? undefined : value), z.coerce.number().int().optional()),
    nome: optionalQueryText(160),
    envio: z.preprocess((value) => (value === "" || value === undefined ? undefined : value), z.enum(["S", "N"]).optional()),
    valor: z.preprocess((value) => (value === "" || value === undefined ? undefined : value), z
        .string()
        .trim()
        .regex(/^\d+(?:[.,]\d{1,2})?$/)
        .transform((value) => value.replace(",", "."))
        .optional()),
    dataInicial: z.preprocess((value) => (value === "" || value === undefined ? undefined : value), z.iso.date().optional()),
    dataFinal: z.preprocess((value) => (value === "" || value === undefined ? undefined : value), z.iso.date().optional()),
    temCodigo: z.preprocess((value) => (value === "" || value === undefined ? undefined : value), z.enum(["S", "N"]).optional()),
    statusEnvio: optionalQueryText(50),
    statusId: z.preprocess((value) => (value === "" || value === undefined ? undefined : value), z.coerce.number().int().positive().optional()),
    order: z
...
export const productListQuerySchema = z.object({
    ...
    fabricacaoPropria: z.preprocess((value) => (value === "" || value === undefined ? undefined : value), z.enum(["S", "N"]).optional()),
    order: z
...
export const peopleListQuerySchema = z.object({
    ...
    envioDesabilitado: z.preprocess((value) => (value === "" || value === undefined ? undefined : value), z.enum(["S", "N"]).optional()),
...
export const goalResourcesResponseSchema = z.object({
    ...
    sectors: z.array(z.object({ id: z.number().int().positive(), name: z.string() })),
});
export const goalCreateInputSchema = z
    ...
    .refine((value) => new Set(value.vendors.map((item) => item.id)).size ===
    value.vendors.length, { message: "Vendedor duplicado" })
    .refine((value) => new Set(value.sectors.map((item) => item.id)).size ===
    value.sectors.length, { message: "Setor duplicado" });
...
export const operationsSettingsUpdateSchema = z
    ...
    .refine((value) => value.kind !== "satisfaction" ||
    !value.enabled ||
...
export const operationsJobRequestSchema = z
    ...
    .refine((value) => (value.jobType !== "bling.sync-nfe" &&
...
export const profitabilityQuerySchema = z.object({
    ...
    dataInicial: z.iso.date(),
    dataFinal: z.iso.date(),
    calculo: z.preprocess((value) => (value === "" || value === undefined ? undefined : value), z.enum(["S", "I", "N"]).optional()),
    somentePrejuizo: z.preprocess((value) => (value === "true" || value === true ? true : false), z.boolean()),
});
...
export const businessOverviewResponseSchema = z.object({
    ...
    commercial: z.object({
        ...
        operationNatures: z.array(z.object({
            id: z.number().int().positive(),
            blingId: z.string().nullable(),
            description: z.string(),
        })),
    ...
    fiscal: z.object({
        fixedCostTypes: z.array(z.object({ id: z.number().int().positive(), label: z.string() })),
