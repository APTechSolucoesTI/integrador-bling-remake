import { dashboardSummarySchema, integrationJobSchema, loginRequestSchema, nfeListQuerySchema, tenantSessionSchema, } from "../src/index.js";
import { describe, expect, it } from "vitest";
const tenantId = "00000000-0000-4000-8000-000000000001";
const userId = "00000000-0000-4000-8000-000000000002";
describe("contratos compartilhados", () => {
    it("rejeita sessão sem tenant permitido", () => {
        expect(tenantSessionSchema.safeParse({
            userId,
    ...
    it("valida envelope observável de job", () => {
        expect(integrationJobSchema.safeParse({
            tenantId,
    ...
    it("normaliza o e-mail sem aceitar senha curta", () => {
        ...
        }).email).toBe("demo@integrador.local");
